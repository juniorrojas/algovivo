...
<body>
  <script type="module">
    import * as algovivo from "https://cdn.jsdelivr.net/gh/juniorrojas/algovivo@23748b8/build/algovivo.min.js";

    async function loadWasm() {
      const response = await fetch("https://cdn.jsdelivr.net/gh/juniorrojas/algovivo@23748b8/build/algovivo.wasm");
