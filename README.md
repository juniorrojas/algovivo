...
<body>
  <script type="module">
    import * as algovivo from "https://cdn.jsdelivr.net/gh/juniorrojas/algovivo@a8d0186/build/algovivo.min.js";

    async function loadWasm() {
      const response = await fetch("https://cdn.jsdelivr.net/gh/juniorrojas/algovivo@a8d0186/build/algovivo.wasm");
