...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.algovivo = {}));
  ...
  var utils = /*#__PURE__*/Object.freeze({
    ...
    makeNdArray: makeNdArray,
    numelOfShape: numelOfShape,
    getArrElem: getArrElem,
    setArrElem: setArrElem
  });
  ...
  class Tensor {
    constructor(args = {}) {
      ...
      const numel = numelOfShape(this.shape);
      this.numel = numel;
    ...
    toArray() {
      ...
      const arr = makeNdArray(this.shape, 0);
      this.forEach(idx => {
        const v = this.get(idx);
        setArrElem(arr, idx, v);
      });
      return arr;
    }
  ...
  class Transform2d {
    ...
    apply(v) {
      return add(this.linear.apply(v), this.translation);
    }
  ...
  var cursorUtils = /*#__PURE__*/Object.freeze({
    __proto__: null,
  ...
  class DragBehavior {
    ...
    linkToDom(domElement, domElementForMoveEvents = null) {
      ...
      const onDomCursorDown = (event) => {
        const domCursor = computeDomCursor(event, domElement);
  ...
  class Mesh {
    ...
    computeCenter() {
      ...
      mulScalar_(center, 1 / numVertices);
      return center;
    }
  }
  ...
  class SystemViewport$1 {
    constructor(args = {}) {
      ...
      const renderer = new Renderer({ headless });
    ...
    _updateMesh(meshData) {
      ...
      mesh.sortedElements = makeSortedElements({
  ...
  var render = /*#__PURE__*/Object.freeze({
    __proto__: null,
    SystemViewport: SystemViewport$1,
  ...
  exports.mm2d = index$1;
  exports.mmgrten = index$7;
  exports.nn = index;
